...
class Ask(tk.Frame):
	...
	def crateFrame(self):
		...
		self.radioOption1 = tk.Radiobutton(self, text="1", variable=self.v, value=0, anchor="w", width=30)
		self.radioOption2 = tk.Radiobutton(self, text="2", variable=self.v, value=1, anchor="w", width=30)
		self.radioOption3 = tk.Radiobutton(self, text="3", variable=self.v, value=2, anchor="w", width=30)
		self.radioOption4 = tk.Radiobutton(self, text="4", variable=self.v, value=3, anchor="w", width=30)
